...
class dataset(object):
    ...
    def __init__(self, sigDict, finger_scene=False,window_size=10,stride=1,signature_depth=2):
        ...
        for key in self.testKeys:
            ...
            sys.stdout.flush()
            sigfeatExt(sigDict[key][True]+sigDict[key][False], self.feats, finger_scene=finger_scene,window_size=self.window_size,stride=self.stride,signature_depth=self.signature_depth)
        print (">>>>> Done <<<<<")
